...
def build_pdf():
    ...
    story.append(Paragraph("<b>Academic Year:</b> 2026-2027 &nbsp;|&nbsp; <b>Team Lead:</b> Gokula Kannan M (SEC25CS196) &nbsp;|&nbsp; <b>Institution:</b> Sri Sai Ram Engineering College", meta_style))
    ...
    # Section 2: Week 1 Fill-in
    story.append(Paragraph("📘 WEEK – 1: ORIENTATION & ENTREPRENEURIAL MINDSET", h1_style))
    w1_text = (
        "<b>1. Understand Entrepreneurship & Innovation:</b><br/>"
        "• <b>Core Problem:</b> Security Operation Centers face extreme alert fatigue (10,000+ daily logs). Commercial AI tools (ChatGPT) cannot be used directly because corporate/government data leaks to third-party cloud servers.<br/>"
        ...
        "• <b>Market Size (TAM/SAM):</b> $13.2 Billion+ Global SIEM Automation & Threat Intel Market (18.5% CAGR).<br/>"
        "• <b>Target Customers:</b> Enterprise SOCs, MSSPs, Air-Gapped Government Labs, Cyber Police Cells, Startups.<br/>"
        "• <b>Entrepreneurial Resourcefulness:</b> Quantizing 70B models down to 4-bit (IQ3_M) to run flagship AI on compact edge hardware."
    )
    story.append(Paragraph(w1_text, body_style))
    story.append(Spacer(1, 6))

    # Section 3: Week 2 Fill-in
    story.append(Paragraph("📙 WEEK – 2: PROBLEM IDENTIFICATION & PASSION CV", h1_style))
    w2_text = (
        "<b>1. Real-World Societal Need:</b><br/>"
        "Small businesses, hospitals, and universities cannot afford $100k+/year enterprise SIEM subscriptions (Splunk / Cortex XSOAR), leaving them vulnerable to ransomware. SENTINEL democratizes security by providing an open-source, self-hosted, autonomous AI SOC co-pilot running locally.<br/><br/>"
        "<b>2. Passion CV — Team Profiles:</b><br/>"
        "• <b>Gokula Kannan M (Team Lead — SEC25CS196, CSE-A):</b> Project Planning, Architecture Governance, Systems Engineering, Venture Strategy.<br/>"
        "• <b>Lakshan M (Member 1 — SEC25CS036, CSE-A):</b> Full-Stack Web Development, React.js UI, WebSockets Integrations, HITL Approval Modals.<br/>"
        ...
        "• <b>Faculty Supervisor:</b> Dr. A. SHEELA (Associate Professor, Department of Computer Science & Engineering, Sri Sai Ram Engineering College)."
    )
