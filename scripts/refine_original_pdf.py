...
def fill_week2_pdf():
    ...
    p1.insert_textbox(fitz.Rect(95, 220, 760, 520), w2_p1_text, fontsize=10, fontname="helv", color=dark)
    ...
    p2.insert_textbox(fitz.Rect(95, 120, 760, 480), w2_p2_text, fontsize=10, fontname="helv", color=dark)

    # Page 3: Bullet 3 (Passion CV)
    p3 = doc[2]
    w2_p3_text = (
        "PASSION CV & TEAM PROFILE MATRIX:\n\n"
        "• Gokula Kannan M (SEC25CS196 | CSE-A Core):\n"
        "  Domain: Software Architecture, Systems Engineering, Project Governance & Venture Strategy.\n"
        "  Contribution: Overall system architecture, sprint management, and project coordination.\n\n"
        "• Lakshan M (SEC25CS036 | CSE-A Core):\n"
        ...
        "• Sivabalan T (SEC25CS101 | CSE-C Core):\n"
        "  Domain: AI Engine Architecture, Zero-Trust Privacy Engineering, Quantization & Vector RAG.\n"
        "  Contribution: Development of Zero-Trust Data Sanitizer (src/sanitizer.py) and 3-Tier AI Router (src/router.py). Individual Hac'KP 2026 Hackathon Finalist.\n\n"
        "• Faculty Supervisor: Dr. A. SHEELA (Associate Professor, Dept. of Computer Science & Engineering)."
    )
    p3.insert_textbox(fitz.Rect(95, 160, 760, 520), w2_p3_text, fontsize=9, fontname="helv", color=dark)
