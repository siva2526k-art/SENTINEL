...
<body>
  ...
  <div class="container">
    <header>
      ...
      <div style="color: var(--text-muted); font-size: 0.9rem;">Sri Sairam Engineering College • Department of Computer Science & Engineering</div>
      ...
      <div class="slide active">
        ...
        <div class="cards-grid">
          <div class="card">
            ...
            <div class="card-title">Presenter & Affiliation</div>
            <div class="card-text"><b>Sivabalan T</b><br>Department of Computer Science & Engineering (2nd Year)<br>Sri Sairam Engineering College</div>
          </div>
          <div class="card">
