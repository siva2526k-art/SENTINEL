"""
SENTINEL — Interactive Enterprise Visual Presentation Deck Generator
Generates a modern dark-mode glassmorphic HTML slide deck with clean enterprise title page and open-source provenance slide.
"""
import os
import sys
...
<head>
  ...
  <title>SENTINEL — Enterprise Autonomous AI SOC Triage & Privacy Platform</title>
...
<body>
  ...
  <div class="container">
    <header>
      ...
      <div style="color: var(--text-muted); font-size: 0.9rem;">Enterprise Product Brief • Version 1.0</div>
      <div class="slide-counter" id="slideNum">SLIDE 1 / 11</div>
    </header>

    <div class="slide-viewport">
      <!-- SLIDE 1: PURE ENTERPRISE PRODUCT COVER -->
      <div class="slide active">
        ...
        <div class="cards-grid">
          <div class="card">
            ...
            <div class="card-title">Enterprise SOC Platform</div>
            <div class="card-text">Autonomous Security Operations Center Triage & Incident Response Platform</div>
          </div>
          <div class="card">
            <div class="card-icon">👤</div>
            <div class="card-title">Lead Security Engineer</div>
            <div class="card-text"><b>Sivabalan T</b><br>Lead System Architect & Senior Security Engineer</div>
          </div>
          <div class="card">
            <div class="card-icon">🚀</div>
            <div class="card-title">Core Architecture</div>
            <div class="card-text">Zero-Trust Privacy Shield + 3-Tier MoE Router + AST Sandbox Guard + Courtroom PDF Briefs</div>
          </div>
        </div>
        <div class="notes-bar" id="notes-1">
          <div class="notes-title">🗣️ Solo Presenter Script (Say Aloud)</div>
          "Good morning. I am Sivabalan T, Lead Architect of SENTINEL. Today I introduce SENTINEL—an enterprise-grade autonomous AI SOC triage and privacy platform engineered for next-generation cyber defense."
        </div>
      </div>
      ...
      <!-- SLIDE 3 -->
      <div class="slide">
        <h1 class="slide-title">💡 SENTINEL Architecture Matrix</h1>
        <div class="slide-subtitle">First-Principles AI System Architecture for Cyber Operations</div>
        <div class="takeaway-bar">📌 TOP TAKEAWAY: SENTINEL unifies Zero-Trust Privacy, 3-Tier AI Cost Control, and AST Code Execution Guarding.</div>
        <div class="cards-grid">
          <div class="card">
            <div class="card-icon">🔒</div>
            <div class="card-title">1. Zero-Trust Sanitizer</div>
            <div class="card-text">Replaces PII with synthetic tokens ([USER_1], [INTERNAL_IP_1]) in encrypted local RAM before transit.</div>
          </div>
          <div class="card">
            <div class="card-icon">🛡️</div>
            <div class="card-title">2. Injection Neutralizer</div>
            <div class="card-text">Neutralizes log-embedded attack phrases ([NEUTRALIZED_PROMPT_INJECTION]) before AI processing.</div>
          </div>
          <div class="card">
            <div class="card-icon">🤖</div>
            <div class="card-title">3. 3-Tier System MoE</div>
            <div class="card-text">Triages 90% routine alerts offline on workstation GPUs for $0 software cost.</div>
          </div>
          <div class="card">
            <div class="card-icon">🔒</div>
            <div class="card-title">4. AST Code Sandbox</div>
        ...
        <div class="notes-bar" id="notes-3">
          <div class="notes-title">🗣️ Solo Presenter Script (Say Aloud)</div>
          "SENTINEL solves this through 4 technical pillars: Zero-Trust Data Sanitization, Prompt Injection Neutralization, 3-Tier AI Cost Optimization, and AST Code Execution Guarding."
        </div>
      </div>
      ...
      <div class="slide">
        ...
        <div class="cards-grid">
          ...
          <div class="card">
            <div class="card-icon">🤖</div>
            <div class="card-title">AI Router (from RouteLLM)</div>
            <div class="card-text"><b>RouteLLM Flaw</b>: Leaks prompt metadata to cloud.<br><b>SENTINEL Fix</b>: Sanitizes prompts first; processes 90% offline on local GPU ($0).</div>
          </div>
          <div class="card">
            <div class="card-icon">🔒</div>
            <div class="card-title">AST Guard (from PyInquirer)</div>
            <div class="card-text"><b>PyInquirer Flaw</b>: Unsafe eval() runtime wrappers.<br><b>SENTINEL Fix</b>: AST syntax tree parsing (ast.parse) blocking os.system().</div>
          </div>
          <div class="card">
            <div class="card-icon">🧠</div>
            <div class="card-title">RAG Memory (from ChromaDB)</div>
...
❌ MALICIOUS: os.system("rm -rf /")         ──► BLOCKED INSTANTLY (AST Security Violation)</div>
      ...
      <div class="slide">
        ...
        <div class="notes-bar" id="notes-11">
          <div class="notes-title">🗣️ Solo Presenter Script (Say Aloud)</div>
          "To conclude, judges: SENTINEL delivers Zero-Trust Privacy, 3-Tier AI Cost Optimization, AST Code Security, and Courtroom PDF Briefs. All 10 architectural levels are verified live. Thank you!"
        </div>
      </div>
    </div>
...
def generate_html_deck(desktop_path=r"C:\Users\siva2\Desktop\SENTINEL_Interactive_Visual_Pitch_Deck.html", docs_path=r"C:\Users\siva2\Projects\SENTINEL\docs\SENTINEL_Interactive_Visual_Pitch_Deck.html"):
    ...
    print(f"✨ Enterprise Top-Down Visual HTML Pitch Deck created successfully at:")
